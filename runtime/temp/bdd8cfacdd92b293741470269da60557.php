<?php /*a:2:{s:45:"../application/index/view/the1/blog/tags.html";i:1542429091;s:40:"../application/index/view/the1/base.html";i:1542423612;}*/ ?>
<title>Perci</title>
...
<a class='date'><?php echo htmlentities($blog['publish_time']); ?></a><br>
  ...
  <a href="<?php echo url('index/blog/tags',['tag'=>$n]); ?>" class="tag"><?php echo htmlentities($n); ?></a>
    ...
    <div class="entry-title">
      <a  href = "<?php echo url('index/blog/read',['id'=>$blog['id']]); ?>" class="ti"><?php echo htmlentities($blog['title']); ?></a>
    </div>
 <div class='b_content'> &nbsp;&nbsp;<?php echo $blog['content']; ?></div><br>
</div>
 <?php endforeach; ?>
</div>
